...
<nav>
	...
	<a href="./searchForBookPage.do">도서 검색</a> 
 	 <a href="./insertRental.rn" class="active">도서 대출</a>
	...
	<div>
		<h3><span id="tableTitle">도서 대출 신청</span></h3><br>
	<div id="bothTable">	
	<form action="./insertRental.rn" method="post">	
		<table border="1" width="700" id="tutorial" cellpadding="5" style="border-color: #5F5F5E ;">
				<input name="risbn" type="hidden" value="1234" />
			<tr>
				<td colspan="2">
					<div>&nbsp;</div>
					<span style="font-size:20px;">&nbsp;※ 도서 대출 이용안내 ※</span><br><br>
					<span>&nbsp;- 이용 가능 시간 : 24시간 연중무휴</span><br><br>
					<span>&nbsp;- 대출 권수 : 1인당 5권</span><br><br>
					<span>&nbsp;- 대출 기간 : 7일</span><br><br>
					<span>&nbsp;- 반납 방법 : 'Rental/Return' 메뉴 - '도서 반납' 메뉴에서 반납<br><br></span>
					<span>&nbsp;- 3권 이상 연체된 회원은 블랙리스트에 올라 도서 대출이 불가해지므로 꼭 대출 기한 내에 반납  <br>
					&nbsp;&nbsp;&nbsp;부탁드립니다. 관련 문의사항은 관리자에게 문의 부탁드립니다.					
					</span><br><br>
				</td>
			</tr>
			<tr style="border-bottom: hidden; border-left:hidden; border-right:hidden;"><td colspan="2">&nbsp;</td></tr>
			<tr style="border-left:hidden; border-right:hidden;"><td colspan="2">&nbsp;</td></tr>
				<tr>
					<td bgcolor="#32A4FF" width="150" height="60" align="center">책 제목</td>
					<td align="center">
						<input name="rtitle" id="booktitle" type="text" class="input_title"/>
					</td>
				</tr>
				<tr>
					<td bgcolor="#32A4FF" width="150" height="60" align="center">작가</td>
					<td align="center">
						<input name="rauthor" id="input_author"cols="90" rows="15">
					</td>
				</tr>
				<tr>
					<td bgcolor="#32A4FF" width="150" height="60" align="center">E-Mail</td>
					<td align="center">
						<input name="remail" cols="90" rows="15">
					</td>
				</tr>		
				<tr>
					<td id="lowbutton" colspan="2" >
						<span style="margin-left:250px;"><input class="submitTable" type="submit" value="대출하기" ></span>&nbsp;&nbsp;&nbsp;
