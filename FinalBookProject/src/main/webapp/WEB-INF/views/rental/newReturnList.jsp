...
<nav>
	...
	<a href="./searchForBookPage.do">도서 검색</a>
 	 <a href="./insertRental.rn" >도서 대출</a>
  	 ...
  	 <a href="./deleteRental.rn" class="active">도서 반납</a>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<h4 style="margin-right:400px;">반납 필요 도서 목록</h4>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
		<form action="./deleteRental.rn" method="get">
			<table id="searchList" border="0" cellpadding="0" cellspacing="0" width="900">
				<tr>	
						...
						<select name="searchCondition" style="height:35px; width:60px;">
							<c:forEach items="${ userconditionMap }" var="option">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		...
		<table class="table-striped table-hover" width="900" style="margin-right:320px;">
			<tr align="center">
				<th bgcolor="#32A4FF" width="100">청구번호</th>
				<th bgcolor="#32A4FF" width="200">제목</th>
				<th bgcolor="#32A4FF" width="150">작가</th>
				<th bgcolor="#32A4FF" width="150">반납일자</th>
				<th bgcolor="#32A4FF" width="150">도서 반납</th>
			</tr>
			<c:forEach items="${rentalList}" var="rental">
			<input name="risbn" type="hidden" value="${ rental.risbn}">
				<tr align="center" height="50">
					<td>${ rental.risbn}</td>
					<td align="center">
						<a href="deleteRental.rn?risbn=${rental.risbn}">${rental.rtitle}</a>
					</td>
					<td>${ rental.rauthor }</td>
					<td>${ rental.rreturnDate }</td>					
					<td>
						<form action="./deleteRental.rn" method="post">
							<button id="return" name="risbn" value="${rental.risbn}">반납</button>
						</form>
					</td>
				</tr>
			</c:forEach>
