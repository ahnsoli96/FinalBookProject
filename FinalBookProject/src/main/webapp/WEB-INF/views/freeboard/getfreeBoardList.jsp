...
<main>
  ...
  <div class="b-example-divider"></div>
  	 <nav>
		<div style="float:left;"class="vertical-menu">
	 	 <a href="./getBoardList.do" >공지사항</a>
	  	 <a href="./getFreeBoardList.do" class="active" >자유게시판</a>
	  	 <a href="./getcumuBoardList.do" >커뮤니티게시판</a> 	
		</div>
	</nav>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<div style="margin-right:320px;"><h4>Free Board</h4></div>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
		<form action="getFreeBoardList.do" method="post">
				...
				<tr>
					<td align="right">
						<select name="searchCondition" style="height:35px; width:60px;">
							<c:forEach items="${ freeconditionMap }" var="option">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		...
		<table class="table-striped table-hover" width="900">
			...
			<c:forEach items="${boardList}" var="board">
				<tr align="center" height="50">
					<td>${ board.seq }</td>
					<td align="center">
						<a href="getfreeBoard.do?seq=${board.seq}">${board.ttl}</a>
					</td>
					<td>${ board.writer }</td>
					<td>${ board.regDate }</td>
					<td>${ board.cnt }</td>
		...
		<tr>
		<td align="right">
		<button type="button" class="btn btn-outline-primary me-2" onclick="location.href='/insertfreeBoard.do';" style="float-right;">새글 등록</button>
		</td>
		</tr>
		</table>
	</div>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="getFreeBoardList.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="getFreeBoardList.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="getFreeBoardList.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}">Next</a></li>
