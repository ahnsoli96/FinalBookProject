	...
	<div align="center">
		...
		<form action="updatefreeBoard.do" method="post">
			...
			<table border="1" cellpadding="0" cellspacing="0" width="700">
				<tr>
					<td bgcolor="#32A4FF" width="250" height="50" align="center">제목</td>
					<td align="left">
						<input name="title" type="text" style="width:530px;height:50px;" value="${board.ttl}" />
					</td>
				</tr>
				<tr>
					<td bgcolor="#32A4FF" align="center">작성자</td>
					<td align="left">&nbsp;${board.writer}</td>
				</tr>
				<tr>
					<td bgcolor="#32A4FF" align="center">내용</td>
					<td align="center">
						<textarea name="content" cols="65" rows="15">${board.content}</textarea>
					</td>
				</tr>
				<tr>
					<td bgcolor="#32A4FF" align="center">등록일</td>
					<td align="left">${board.regDate}</td>
				</tr>
				<tr>
					<td bgcolor="#32A4FF" align="center">조회수</td>
					<td align="left">${board.cnt}</td>
				</tr>
				<tr>
					<td colspan="2" align="center" bordercolor="#F4FFFF" >
						<input class="btn btn-outline-primary me-2" type="submit" value="글 수정" />
						<button class="btn btn-outline-primary me-2" onclick="location.href='/deletefreeBoard.do?seq=${ board.seq }';">글삭제</button>
					</td>
				</tr>
			</table>
		</form>
		...
		<tr>
		<td align="right">
		<button type="button" class="btn btn-outline-primary me-2" onclick="location.href='/getFreeBoardList.do';" style="float-right;">글 목록</button>
		</td>
		</tr>
		</table>
