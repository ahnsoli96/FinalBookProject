 ...
 <div class="container" >
  ...
  &nbsp;${board.content}
    ...
    <div style="text-align:center;">
        <button type="button" class="btn btn-outline-primary me-2" onclick="location.href='/updatefreeBoardform.do?seq=${board.seq}';">수정</button>
        <button type="button" class="btn btn-outline-danger" onclick="location.href='/deletefreeBoard.do';">삭제</button>
        <button type="button" class="btn btn-outline-warning" onclick="location.href='/getFreeBoardList.do';">목록</button>
      </div>
  <div>&nbsp;</div>
  <div>&nbsp;</div>
  <form action="reply.do?seq=${board.seq}" method="post">
  <div style="text-align:center;">
  <input name="seq" type="hidden" value="${board.seq}" />
  <div class="mb-3" align="center" style="display: inline-block;">
  아이디<input type="text" name="id" class="form-control" style="width:150px;height:30px;font-size:18px;" value="${id}">
  비밀번호<input type="password" name="password" class="form-control" style="width:150px;height:30px;">
  </div>
  <div class="mb-3" align="center" style="display: inline-block;">
  <input type="text" class="form-control" name="contents" id="exampleFormControlInput1" style="width:650px;height:150px;font-size:18px;">
  </div>
  <div class="mb-3" align="center" style="display: inline-block;">
  ...
  <table class="table-striped table-hover" width="1000" style="margin-left:auto;  margin-right:auto; border-top:1px blue solid; border-bottom: 1px blue solid;">
			...
			<c:forEach items="${boardList}"  var="boardList">
				<tr align="center" height="50">
					<td>${boardList.id}</td>
					<td><a href="getdetailreply.do?seqs=${boardList.seqs}">${boardList.contents}</a></td>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="getfreeBoard.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}&seq=${board.seq}">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="getfreeBoard.do${pageMaker.makeQuery(idx)}&seq=${board.seq}">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="getfreeBoard.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}&seq=${board.seq}">Next</a></li>	
  </ul>
</nav>
      <div>&nbsp;</div>
