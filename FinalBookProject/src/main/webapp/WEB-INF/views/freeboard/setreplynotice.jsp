...
<div class="container" >
  ...
  <textarea name="contents" cols="100" rows="16" >&nbsp;${boardreply.contents}</textarea>
    ...
    <div style="text-align:center;">
      	<button type="submit" formaction="updatereply.do?seq=${boardrely.seq}" class="btn btn-outline-danger" >수정</button>
      	<button type="submit" class="btn btn-outline-primary me-2" formaction="/deletereply.do?seq=${boardrely.seq}" onclick="return confirm('정말 삭제하시겠습니까?')">삭제</button>
 			
 	</form>
     	<button type="button" class="btn btn-outline-warning" onclick="location.href='/getfreeBoard.do?seq=${boardreply.seq}';" >목록</button>
     </div>
  <div>&nbsp;</div>															
