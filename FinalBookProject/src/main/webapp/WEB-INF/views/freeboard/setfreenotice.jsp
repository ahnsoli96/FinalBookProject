...
<div class="container" >
  ...
  <div>&nbsp;</div>
  <form action="/updatefreeBoard.do">
  ...
  제목 : <input name="ttl" type="text" style="width:340px;height:30px;" value="${board.ttl}"  />
  ...
  <textarea name="content" cols="100" rows="16">${board.content}</textarea>
  </td>
  </tr>
   </table>
      <div>&nbsp;</div>
    <div style="Text-Align: Center;">
      	...
      	<a href="getfreeBoard.do?seq=${board.seq}" class="btn btn-outline-danger">목록</a>
      	</div>
      	 </form>
