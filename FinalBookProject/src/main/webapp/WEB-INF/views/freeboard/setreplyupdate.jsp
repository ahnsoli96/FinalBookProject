...
<div class="container" >
  ...
  <div>&nbsp;</div>
  <form action="/updatereply.do?seq=${boardrely.seq}">
  ...
  비밀번호 : <input name="password" type="password" style="width:330px;height:30px;" />
  <input name="id" type="hidden" style="width:530px;height:50px;" value="${boardreply.id}" />
  </td>
  <td width="100" height="80" align="right" style="white-space: nowrap;">
  등록일 : ${boardreply.regDate}&nbsp;
  </td>
  </tr>
  ...
  <textarea name="contents" cols="100" rows="16">&nbsp;${boardreply.contents}</textarea>
    ...
    <div>&nbsp;</div>
    <div class="col-md-3 text-end" style="text-align:center; margin-left:650px;">
      	<input type="submit" class="btn btn-outline-primary me-2" value="수정" onclick="return confirm('정말 수정하시겠습니까?')">
