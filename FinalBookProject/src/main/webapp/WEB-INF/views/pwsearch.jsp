    ...
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        <h4 class="mb-3" style="text-align: center;">비밀번호 찾기</h4>
          ...
          <hr class="mb-4">
          <div class="mb-4" ></div>
          <button class="btn btn-primary" style="width:305px; display:inline;" id="findBtn">임시비밀번호</button>
          <button class="btn btn-primary" style="width:305px; display:inline;" onclick="location.href='/twopwsearch.me';">비밀번호 변경</button>        
