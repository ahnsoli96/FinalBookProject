...
<main>
  ...
  <div class="mybox"><h3>&nbsp;</h3><h3>&nbsp;</h3><h3 align="center">Welcome to the ${ userName } Library Management Program</h3><h3>&nbsp;</h3><h3>&nbsp;</h3></div>
...
<!-- 탭 메뉴 상단 시작 -->
	<ul class="tabs" style="margin-right:560px;">
		<li class="tab-link current" data-tab="tab-1">도서관리</li>
		<li class="tab-link" data-tab="tab-2">게시판관리</li>
		<li class="tab-link" data-tab="tab-3">회원관리</li>
	</ul>
<!-- 탭 메뉴 상단 끝 -->
<!-- 탭 메뉴 내용 시작 -->
<div id="tab-1" class="tab-content current">
	<div class="card" style="width: 18rem; display: inline-block;">
  <img src="image/lb4.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">도서 등록</h5>
    <p class="card-text">새로운 도서를 등록해보세요.</p>
    <a href="./insertBook.do" class="btn btn-danger">바로가기</a>
  </div>
  </div>

  
 <div class="card" style="width: 18rem; display: inline-block; ">
  <img src="image/updateBookIcon.jpg" class="card-img-top" alt="...">
    <div class="card-body">
    <h5 class="card-title">도서 수정</h5>
    <p class="card-text">보유하고 있는 도서를 수정하세요.</p>
    <a href="./getAdminBookList.do" class="btn btn-danger">바로가기</a>
  </div>
  </div>
  
  <div class="card" style="width: 18rem; display: inline-block; ">
  <img src="image/deleteBook.jpg" class="card-img-top" alt="..." style="background-size:contain;">
    <div class="card-body">
    <h5 class="card-title">도서 삭제</h5>
    <p class="card-text">사용하지 않는 도서는 삭제하세요.</p>
    <a href="./deleteBook.do" class="btn btn-danger">바로가기</a>
  </div>
  </div> 
  ...
  <div class="card" style="width: 18rem; display: inline-block;">
	  <img src="image/hopebook.jpg" class="card-img-top" alt="...">
	    <div class="card-body">
	    <h5 class="card-title">희망 도서</h5>
	    <p class="card-text"> 원하는 도서를 알아보세요</p>
	    <a href="./hopeAdminlist.do" class="btn btn-danger">바로가기</a>
	  </div>
  </div>
  
  <div class="card" style="width: 18rem; display: inline-block; ">
	  <img src="image/board.jpg" class="card-img-top" alt="...">
	    <div class="card-body">
	    <h5 class="card-title">게시판 관리</h5>
	    <p class="card-text">게시판 글을 관리해보세요.</p>
	    <a href="./getAdminFreeBoardList.do" class="btn btn-danger">바로가기</a>
	  </div>
  </div>
  
  <div class="card" style="width: 18rem; display: inline-block; ">
	  <img src="image/noticeboard.jpg" class="card-img-top" alt="...">
	    <div class="card-body">
	    <h5 class="card-title">공지사항 관리</h5>
	    <p class="card-text">공지할 글을 관리해보세요.</p>
	    <a href="./getAdminBoardList.do" class="btn btn-danger">바로가기</a>
	  </div>
  	  </div>   
	</div>
...
<div id="tab-3" class="tab-content">	
    <div class="card" style="width: 18rem; display: inline-block; ">
	  <img src="image/updateuser.jpg" class="card-img-top" alt="...">
	    <div class="card-body">
	    <h5 class="card-title">회원 수정</h5>
	    <p class="card-text">회원 정보를 수정해보세요.</p>
	    <a href="./getmemberList.do" class="btn btn-danger">바로가기</a>
	  </div>
  </div>
  
  <div class="card" style="width: 18rem; display: inline-block; ">
	  <img src="image/deleteuser.jpg" class="card-img-top" alt="...">
	    <div class="card-body">
	    <h5 class="card-title">회원 삭제</h5>
	    <p class="card-text">회원 정보를 삭제해보세요.</p>
	    <a href="./getmemberList.do" class="btn btn-danger">바로가기</a>
	  </div>
  	  </div>
      ...
      <div class="card" style="width: 18rem; display: inline-block; ">
	  <img src="image/blacklist.jpg" class="card-img-top" alt="...">
	    <div class="card-body">
	    <h5 class="card-title">블랙 리스트</h5>
	    <p class="card-text">블랙 리스트 회원을 관리하세요.</p>
	    <a href="./delayedRentalList.rn" class="btn btn-danger">바로가기</a>
	  </div>
  </div>   
	</div>
<!-- 탭 메뉴 내용 끝 -->
