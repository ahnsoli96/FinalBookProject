...
<main>
  ...
  <div class="b-example-divider"></div>
	...
	<div class="container-fluid px-4">
		<h1 class="mt-4" align="center">공지사항 수정</h1>
			&nbsp;
		<div class="card mb-4" style="width:1000px; margin:auto;">
			<div class="card-body" style="width:1000px;">
				<form action="/updateBoard.do">
					<input type="hidden" name="auseq" value="${board.auseq}">
					<div class="mb-3">
						<label for="title" class="form-label">제목</label> 
						<input type="text" class="form-control" id="autitle" name="autitle" value="${board.autitle}">
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">작성자</label> 
						<input type="text" class="form-control" id="auwriter" name="auwriter" value="${board.auwriter}">
					</div>
					<div class="mb-3">
						<label for="content" class="form-label">내용 상세정보</label>
						<textarea class="form-control" id="aucontent" name="aucontent" cols="40" rows="9">${board.aucontent}</textarea>
					</div>
