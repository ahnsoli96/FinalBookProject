...
<nav>
	<div style="float:left;"class="vertical-menu">
  	 <a href="./getmemberList.do">회원 수정 / 삭제</a>
  	 <a href="./delayedRentalList.rn" class="active" >블랙리스트 관리</a>  	
	</div>
</nav>
	...
	<div align="center" style="margin-right:200px;">
		...
		<table class="table-striped table-hover" width="500" style="float:left; margin-left: 200px;">
			<tr>
			...
			<tr><td style="background-color: white;">&nbsp;</td></tr>
			<tr align="center">
				<th bgcolor="#CD1039" width="150">아이디</th>
				<th bgcolor="#CD1039" width="150">이메일</th>
				<th bgcolor="#CD1039" width="150">블랙리스트</th>
			</tr>
			<c:forEach items="${delayedList}" var="list">			
				<tr align="center" height="50">					
					<td>${list.rid}</td>
					<td>${list.remail}</td>
					<td>
						<a href="/addBlackList.do?id=${list.rid}&email=${list.remail}" onclick="return confirm('정말 ${list.rid}님을 블랙리스트에 등록하시겠습니까?')" class="btn btn-outline-danger">등록</a>
					</td>		
				</tr>				
			</c:forEach>
		</table>

		<form action="./deleteBlackList.do">
			<table class="table-striped table-hover" width="500"  style="float:right;">		
			<tr>
				<td colspan="3" align="center" style="background-color: white;">
					<h4>블랙리스트 등록 / 목록</h4>
				</td>
			...
			<c:forEach items="${blackList}" var="list">
				<tr align="center" height="50">
					...
					<td>
						...
						<input type="submit" value="삭제" onclick="return confirm('정말 ${list.id}님을 블랙리스트에서 제외하시겠습니까?')" class="btn btn-outline-danger"/>
					</td>			
				</tr>
			</c:forEach>
		</table>
