...
#return{
      	width:80px;	background-color:#CD1039;
...
<nav>
	<div style="float:left;"class="vertical-menu">
 	 <a href="./hopeAdminlist.do" class="active" >희망 도서 신청</a>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<h4 style="margin-right:340px;">Wish List</h4>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
		<form action="./hopeAdminlist.do" method="get">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		...
		<table class="table-striped table-hover" width="900">
			<tr align="center">
				...
				<th bgcolor="#CD1039" width="150">작가</th>
				<th bgcolor="#CD1039" width="150">신청일자</th>
			</tr>
			<c:forEach items="${boardList}" var="book">
				<tr align="center" height="50">
					<td align="center">
						<a href="gethopeAdmin.do?seq=${book.seq}">${book.title}</a>
					</td>
					<td>${ book.writer }</td>				
					<td>${ book.regdate }</td>	
				</tr>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="hopeAdminlist.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}" style="color:#CD1039;">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="hopeAdminlist.do${pageMaker.makeQuery(idx)}" style="color:#CD1039;">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="hopeAdminlist.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}" style="color:#CD1039;">Next</a></li>
