...
.submitTable{
      	width:50px;	background-color:#309AFF;
      	height:30px; border-style:solid;
      	border-color:#309AFF;
      	font-size: 16px;
      	color:white;
...
<nav>
	<div style="float:left;"class="vertical-menu">
 	 <a href="./insertBook.do" >도서 등록</a>
  	 <a href="./getAdminBookList.do">도서 수정</a>
  	 <a href="./deleteBook.do" class="active" >도서 삭제</a> 	
	</div>
</nav>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<h4 style="margin-right:400px;">도서 삭제</h4>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
		...
		<table class="table-striped table-hover" width="900">
			...
			<tr align="center">
				...
				<th bgcolor="#CD1039" width="150">&nbsp;</th>
			</tr>
			...
			<input name="isbn" type="hidden" value="${ book.isbn}">
				<tr align="center" height="50">
					...
					<td>${ book.genre }</td>					
					<td>
						<form action="/deleteBook.do" method="post" onsubmit="return confirm('정말 해당 책을 삭제하시겠습니까?');">
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" style="color:#CD1039;" href="deleteBook.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" style="color:#CD1039;"href="deleteBook.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" style="color:#CD1039;"href="deleteBook.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}">Next</a></li>
  </ul>
</nav>
