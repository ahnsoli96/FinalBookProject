...
<main>
  ...
  <nav>
	<div style="float:left;"class="vertical-menu">
 	 <a href="./hopeAdminlist.do" >희망 도서 신청</a>
  	 <a href="./getAdminFreeBoardList.do" class="active" >자유게시판</a>
  	 <a href="./getAdminBoardList.do" >공지사항 관리</a> 	
	</div>
</nav>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<div style="margin-right:270px;"><h4>Free Board Management</h4></div>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
		<form action="getAdminFreeBoardList.do" method="post">
		...
		<table class="table-striped table-hover" width="900">
			...
			<c:forEach items="${boardList}" var="board">
				<tr align="center" height="50">
					<td>${ board.seq }</td>
					<td align="center">
						<a href="getAdminfreeBoard.do?seq=${board.seq}">${board.ttl}</a>
					</td>
					<td>${ board.writer }</td>
					<td>${ board.regDate }</td>
				</tr>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="getAdminFreeBoardList.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}" style="color:#CD1039;">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="getAdminFreeBoardList.do${pageMaker.makeQuery(idx)}" style="color:#CD1039;">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="getAdminFreeBoardList.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}" style="color:#CD1039;">Next</a></li>
