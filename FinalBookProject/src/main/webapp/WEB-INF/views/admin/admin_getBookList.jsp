...
<nav>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<h4 style="margin-right:400px;">전체 도서 목록</h4>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
		<form action="/getAdminBookList.do" method="get">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		...
		<table class="table-striped table-hover" width="900">
			<tr align="center">
				<th bgcolor="#CD1039" width="100">청구번호</th>
				<th bgcolor="#CD1039" width="200">제목</th>
				<th bgcolor="#CD1039" width="150">작가</th>
				<th bgcolor="#CD1039" width="150">장르</th>
			</tr>
			...
			<input name="isbn" type="hidden" value="${ book.isbn}">
				<tr align="center" height="50">
					<td>${ book.isbn}</td>
					<td align="center">
						<a href="getAdminBook.do?isbn=${book.isbn}">${book.title}</a>
					</td>
					<td>${ book.author }</td>	
					<td>${ book.genre }</td>			
				</tr>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link"  style="color:#CD1039;"href="getAdminBookList.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="getAdminBookList.do${pageMaker.makeQuery(idx)}" style="color:#CD1039;">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="getAdminBookList.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}" style="color:#CD1039;">Next</a></li>
