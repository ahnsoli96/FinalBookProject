...
<main>
 ...
 <% String id = (String)session.getAttribute("id"); %>
  ...
  <td width="240" height="80" align="right">
  작성자: ${board.auwriter}&nbsp;&nbsp;&nbsp;${board.auregDate}&nbsp;
  </td>
  </tr>
  ...
  &nbsp;${board.aucontent}
    ...
    <div style="text-align:center;">
        <button type="button" class="btn btn-outline-primary me-2" onclick="location.href='/updateAdminAnnouncement.do?auseq=${board.auseq}';">수정</button>
        <button type="button" class="btn btn-outline-danger" onclick="location.href='/deleteAdminBoard.do?auseq=${board.auseq}';">삭제</button>
        <button type="button" class="btn btn-outline-warning" onclick="location.href='/getAdminBoardList.do';">목록</button>
      </div>
  <div>&nbsp;</div>
  <div>&nbsp;</div>
