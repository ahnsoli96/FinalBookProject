...
<main>
  ...
  <div class="b-example-divider"></div>
	...
	<div class="container-fluid px-4">
		<h1 class="mt-4" align="center">공지사항 등록</h1>
			&nbsp;
		<div class="card mb-4" style="width:1000px; margin:auto;">
			<div class="card-body" style="width:1000px;">
				<form action="./insertAnnouncement.do" method="post" >
					<input type="hidden" name="image" value="">
					<div class="mb-3">
						<label for="title" class="form-label">제목</label> 
						<input type="text" class="form-control" id="autitle" name="autitle" >
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">작성자</label> 
						<input type="text" class="form-control" id="auwriter" name="auwriter" >
					</div>
					<div class="mb-3">
						<label for="content" class="form-label">내용 상세정보</label>
						<textarea class="form-control" id="aucontent" name="aucontent" cols="40" rows="9"></textarea>
					</div>
