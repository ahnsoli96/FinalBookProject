...
<nav>
	<div style="float:left;"class="vertical-menu">
  	 <a href="./getmemberList.do" class="active" >회원 수정 / 삭제</a>
  	 <a href="./delayedRentalList.rn" >블랙리스트 관리</a>  	
	</div>
</nav>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<div style="margin-right:310px;"><h4>회원 목록</h4></div>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
		<form action="./getmemberList.do" method="get">
			<table id="searchList" border="0" cellpadding="0" cellspacing="0" width="900" style="margin-left:310px;">
				<tr>
								<td align="right">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		...
		<table class="table-striped table-hover" width="900">
			<tr align="center">
				<th bgcolor="#CD1039" width="200">아이디</th>
				<th bgcolor="#CD1039" width="150">이름</th>
				<th bgcolor="#CD1039" width="150">이메일</th>
			</tr>
			<c:forEach items="${memberList}" var="member">
				<tr align="center" height="50">
					<td align="center">
						<a href="getadminmember.do?id=${member.id}">${member.id}</a>
					</td>
					<td>${ member.name }</td>	
					<td>${ member.email }</td>			
				</tr>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="getmemberList.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="getmemberList.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="getmemberList.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}">Next</a></li>
