 ...
 <% String id = (String)session.getAttribute("id"); %>
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
	...
	<div class="container-fluid px-4">
		<h1 class="mt-4" align="center">새 도서 등록</h1>
			&nbsp;
		<div class="card mb-4" style="width:1000px; margin:auto;">
			<div class="card-body" style="width:1000px;">
				<form action="./insertBook.do" method="post" enctype="multipart/form-data" id="bookForm">
					...
					<div class="mb-3">
						<label for="title" class="form-label">지은이</label> 
						<input type="text" class="form-control" id="author" name="author" value="${book.author}">
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">장르</label> 
						<input type="text" class="form-control" id="genre" name="genre">
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">출판사</label> 
						<input type="text" class="form-control" id="publisher" name="publisher">
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">총 권수(default값은 5입니다.)</label> 
						<input type="number" class="form-control" id="bcount" name="bcount" value="5">
					</div>
					<div class="mb-3">
						<label for="content" class="form-label">책 상세정보</label>
						<textarea class="form-control" id="summary" name="summary" cols="40" rows="9"></textarea>
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">표지 img</label> <br>
						<input type="file" name="uploadFile" id="uploadFile" value="파일 첨부"/>
					</div>
					<input class="btn btn-outline-success" type="submit" value="등록" onclick="return validateForm()">
					<a href="javascript:history.go(-1)" class="btn btn-outline-danger">취소</a>
				</form>
			</div>
		</div>
	</div>
