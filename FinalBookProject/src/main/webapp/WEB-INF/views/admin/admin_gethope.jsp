...
<main>
  ...
  <div class="b-example-divider"></div>
	...
	<div class="container-fluid px-4">
		<h1 class="mt-4" align="center">희망 도서</h1>
			&nbsp;
		<div class="card mb-4" style="width:1000px; margin:auto;">
			<div class="card-body" style="width:1000px;">
				...
				<input type="hidden" name="seq" value="${board.seq}">
					<div class="mb-3 mt-3">
						<label for="bno" class="form-label">seq</label>
							<input
							type="text" class="form-control disabled-input" id="seq" name="seq"
							value="${board.seq}" disabled>
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">title</label> <input
							type="text" class="form-control disabled-input" id="title" name="title"
							value="${board.title}" disabled>
					</div>
					<div class="mb-3">
						<label for="author" class="form-label">author</label> <input
							type="text" class="form-control disabled-input" id="author" name="author"
							value="${board.author}" disabled>
					</div>
					<div class="mb-3">
						<label for="content" class="form-label">content</label>
						<textarea class="form-control disabled-input" id="content" name="content" disabled>${board.content}</textarea>
					</div>
					<div class="mb-3">
						<label for="regDate" class="form-label">regdate</label> <input
							type="text" class="form-control disabled-input" id="regDate" name="regDate"
							value="${board.regdate}" disabled>
					</div>
					<div class="mb-3">
						<label for="writer" class="form-label">writer</label> <input
							type="text" class="form-control disabled-input" id="writer" name="writer"
							value="${board.writer}" disabled>
					</div>
					<a href="hopeAdminlist.do" class="btn btn-outline-primary">목록으로</a> 
					<input class="btn btn-outline-success" type="submit" value="도서 등록">
					<a href="admindeletehope.do?seq=${board.seq}" class="btn btn-outline-danger"
						onclick="return confirm('삭제하시겠습니까?')">요청 삭제</a>
				</form>
			</div>
		</div>
	</div>
