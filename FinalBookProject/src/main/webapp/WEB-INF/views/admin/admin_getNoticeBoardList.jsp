...
<main>
  ...
  <nav>
	<div style="float:left;"class="vertical-menu">
 	 <a href="./hopeAdminlist.do">희망 도서 신청</a>
  	 <a href="./getAdminFreeBoardList.do">자유게시판</a>
  	 <a href="./getAdminBoardList.do" class="active" >공지사항 관리</a> 	
	</div>
</nav>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<div style="margin-right:320px;"><h4>Announcement Management</h4></div>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
		<form action="getAdminBoardList.do" method="post">
			<table border="0" cellpadding="0" cellspacing="0" width="900" style="margin-right:320px;">
				<tr>
								<td align="right">
						<select name="searchCondition" style="height:35px; width:60px;">
							<c:forEach items="${ conditionMap }" var="option">
								<option value="${ option.value }">${ option.key }
							</c:forEach>							
						</select> 
						<input type="text"  name="searchKeyword" style="height:35px;" /> 
						<button type="submit" value="검색" style="height:35px; width:60px; margin-bottom:5px;" class="btn btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		...
		<table class="table-striped table-hover" width="900">
			<tr align="center">
				<th bgcolor="#CD1039" width="100">번호</th>
				<th bgcolor="#CD1039" width="200">제목</th>
				<th bgcolor="#CD1039" width="150">작성자</th>
				<th bgcolor="#CD1039" width="150">등록일</th>
			</tr>
			<c:forEach items="${boardList}" var="board">
				<tr align="center" height="50">
					<td>${ board.auseq }</td>
					<td align="center">
						<a href="getAdminBoard.do?auseq=${board.auseq}">${board.autitle}</a>
					</td>
					<td>${ board.auwriter }</td>
					<td>${ board.auregDate }</td>
				</tr>
			</c:forEach>
		</table>
		...
		<td align="right">
		<br>
		<button type="button" class="btn btn-outline-danger" onclick="location.href='/insertAnnouncement.do';" style="float-right;">새글 등록</button>
		</td>
		</tr>
		</table>
	</div>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="getAdminBoardList.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}" style="color:#CD1039;">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="getAdminBoardList.do${pageMaker.makeQuery(idx)}" style="color:#CD1039;">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="getAdminBoardList.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}" style="color:#CD1039;">Next</a></li>
