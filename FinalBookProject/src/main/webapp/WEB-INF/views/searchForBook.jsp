...
<nav>
	<div style="float:left;"class="vertical-menu">
	 <a href="./searchForBookPage.do" class="active" >도서 검색</a>  
 	 <a href="./insertRental.rn" >도서 대출</a>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div align="center" style="margin-right:380px;">
			<h3>도서 검색</h3>
		</div>
		<div>&nbsp;</div>	
	<form action="./searchForBook.do" method="post">
		<div style="margin-right:350px;">
			<select name="searchCondition" style="width:110px; height:40px;">
					<c:forEach items="${ conditionMap }" var="option" >
						<option value="${ option.value }">${ option.key }
					</c:forEach>							
			</select> 
			<input type="text"  name="searchKeyword" style="width:450px; height:40px;"/> 
			<button type="submit" style="height:41px; width:80px; margin-bottom:5px;" class="btn btn-outline-primary me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		...
		<!-- 검색 시작 -->
			...
			<table id="searchList" border="0" cellpadding="0" cellspacing="0" width="900" class="table-striped table-hover">
				<tr align="right" class="no-hover">
					<td colspan="4">						
					</td>
				</tr>
				<tr align="center">
