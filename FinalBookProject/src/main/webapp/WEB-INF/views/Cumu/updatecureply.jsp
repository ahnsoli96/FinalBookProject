...
<div class="container" >
  ...
  ${boardcureply.curegdate}&nbsp;
  </td>
  </tr>
  <tr style="border-top:1px black solid; ">
  <td width="900" height="300" valign="top" align="left">
  <textarea name="cucontents" cols="100" rows="16">&nbsp;${boardcureply.cucontents}</textarea>
  </td>
  </tr>
   </table>
    <div>&nbsp;</div>
    <div class="col-md-3 text-end" style="text-align:center; margin-left:700px;">
		...
		<button type="button" class="btn btn-outline-warning" onclick="location.href='/getcumuBoard.do?cuseq=${boardcureply.cuseq}';" >목록</button>
	</div>
     </form>
