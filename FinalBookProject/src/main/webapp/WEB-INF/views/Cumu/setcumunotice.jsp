...
<div class="container" >
  ...
  <div>&nbsp;</div>
  <form action="/updatecumuBoard.do">
  <input name="cuseq" type="hidden" value="${board.cuseq}" />
  ...
  <tr>
  <td width="700" height="80" align="left" colspan="2">
  제목 : <input name="cutitle" type="text" style="width:300px;height:30px;" value="${board.cutitle}"  />
   <input name="cuwriter" type="hidden"  value="${board.cuwriter}"  />
  </td>
  ...
  <tr style="border-top:1px black solid; ">
  	<td width="900" height="300" valign="top" align="left" colspan="2">
  		<textarea name="cucontent" cols="120" rows="16">${board.cucontent}</textarea>
  	</td>
  </tr>
   </table>
    <div>&nbsp;</div>
    <div class="col-md-3 text-end" style="text-align:center; margin-left:700px;">
      	<input type="submit" class="btn btn-outline-primary me-2" value="수정">
      	<a href="getcumuBoard.do?cuseq=${board.cuseq }" class="btn btn-outline-danger">목록</a>
      </div>
  <div>&nbsp;</div>
