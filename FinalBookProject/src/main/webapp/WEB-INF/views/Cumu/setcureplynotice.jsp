...
<div class="container" >
  ...
  <div>&nbsp;</div>
  <form>
  <input name="cuseqs" type="hidden" value="${boardcureply.cuseqs}" />
  <input name="cuseq" type="hidden" value="${boardcureply.cuseq}" />
  ...
  작성자 : <input name="idds" type="text" style="width:300px;height:30px;" value="${boardcureply.id}" disabled/>
  <input name="id" type="hidden" value="${boardcureply.id }">
  </td>
  <td width="100" height="70" align="right" style="white-space: nowrap;">
  등록일 : ${boardcureply.curegdate}&nbsp;
  </td>
  </tr>
  <tr style="border-top:1px black solid; ">
  <td width="900" height="300" valign="top" align="left" style="padding-top:5px;">
  <textarea name="cucontents" cols="100" rows="16"  style="border-style: hidden;">&nbsp;${boardcureply.cucontents}</textarea>
  </td>
  </tr>
   </table>
    <div>&nbsp;</div>
    <div style="text-align:center;">
      	<button type="submit" class="btn btn-outline-primary me-2" formaction="/updatecureply.do?cuseqs=${boardcureply.cuseqs}';" onclick="return confirm('정말 수정하시겠습니까?')">수정</button>
      	<button type="submit" class="btn btn-outline-danger" formaction="deletecureply.do?cuseqs=${boardcureply.cuseqs}" onclick="return confirm('정말 삭제하시겠습니까?')">삭제</button>
		<button type="button" class="btn btn-outline-warning" onclick="location.href='/getcumuBoard.do?cuseq=${boardcureply.cuseq}';" >게시글로</button>
	</div>
     </form>
