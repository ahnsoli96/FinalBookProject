	...
	<div class="container-fluid px-4">
		...
		<div class="card mb-4" style="width:1000px; margin:auto;">
			<div class="card-body" style="width:1000px;">
				<form action="inserthope.do" method="post">
					<div class="mb-3 mt-3">
						<label for="bno" class="form-label">번호</label> <input type="text"
							class="form-control" id="seq" name="seq" 
							disabled>
					</div>
					<div class="mb-3">
					...
					<a href="hopelist.do" class="btn btn-outline-secondary">list</a> 
					<input class="btn btn-outline-warning" type="submit" value="insert">
				</form>
			</div>
		</div>
	</div>
