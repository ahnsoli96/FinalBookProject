...
<nav>
	<div style="float:left;"class="vertical-menu">
	 <a href="./searchForBookPage.do">도서 검색</a> 
 	 <a href="./insertRental.rn" >도서 대출</a>
  	 <a href="./getBookList.do" class="active">전체 도서 목록</a>
  	 <a href="./deleteRental.rn" >도서 반납</a> 	
	</div>
</nav>
...
<div class="bookTable">
	<h2 style="font-weight: bold;">&nbsp;&nbsp;&lt;${book.title}&gt;
	<span style="font-size:22px;">&nbsp;&nbsp; 저자 ${book.author}</span>
	</h2>
	
	<br><br>
	<form action="insertRentalButton.rn" name="submitTable" id="bookForm" method="post">
		<input type="hidden" value="${book.isbn}" name="bookInput">
		<table border="1" style="width:1000px;">
			<tr>
				<td style="width:300px; border:hidden; padding-right:20px;" rowspan="5">		
					<div>
						<img id="bookImage" src="bookimage/${book.image}" alt="..." style="border:2px solid black;"/>
					</div>		 
				</td>
			...
			<tr style="border-right:hidden;">
				<td valign="top" class="columns" height="200" style=" border-bottom: hidden;">
					상세 정보
				</td>
				<td valign="top" class="values" style=" border-bottom: hidden;border-left:hidden;">
					${book.summary} 
				</td>
			</tr>
			<tr style="border-bottom: hidden; border-right: hidden;">
				<td id="lowButton" align="center" valign="middle" colspan="3" style="height:120px; border-bottom:hidden;">
					<span><input class="submitTable" type="submit" value="대출하기" ></span>&nbsp;&nbsp;&nbsp;
					<button class="submitTable"type="button" onclick="location.href='/getBookList.do';">목록</button>
				</td>	
			</tr>		
		</table>
	</form>
	...
	<div>&nbsp;</div>
	 ...
	 <div style="margin-left:480px;" class="container px-4 py-5" id="hanging-icons">
    <h5>&nbsp;</h5>
    <h2 class="pb-2 border-bottom">${book.genre} 관련 도서</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <c:forEach items="${recommand}" var="rm">
      <div class="col d-flex align-items-start">
        <div style="float:left;" class="icon-square text-bg-light d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
          <svg class="bi" width="1em" height="1em"><use xlink:href="#toggles2"/></svg>
        </div>
        <div style="float:left;">
			<img src="bookimage/${rm.image}" style="width:250px; height:310px; border:1px solid black;" alt="..."/>
          <h3 class="fs-2" style="font-size: 24px; padding-top:5px;">${rm.title}</h3>
          <p >지은이 : ${rm.author}</p>
          <p>대여 가능 권수 : ${rm.bcount}</p>
          <a href="getBook.do?isbn=${rm.isbn}&genre=${rm.genre}" class="btn btn-primary">
            자세히보기
          </a>
        </div>
      </div>
