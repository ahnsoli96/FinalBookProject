...
<div class="container" >
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
	...
	<div class="container-fluid px-4">
		<h1 class="mt-4" align="center">Announcement</h1>
			&nbsp;
		<div class="card mb-4" style="width:1000px; margin:auto;">
			<div class="card-body" style="width:1000px;">
					...
					<label for="writer" class="form-label">작성자</label> <input
							type="text" class="form-control" id="writer" name="auwriter"
							value="${board.auwriter}" disabled>
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">제목</label> <input
							type="text" class="form-control" id="title" name="autitle"
							value="${board.autitle}" disabled>
					</div>
					<div class="mb-3">
					<label for="content" class="form-label">내용</label>
						<textarea style="height:300px; background-color:white;"
							class="form-control" id="aucontent" name="aucontent"
							disabled>${board.aucontent}</textarea>
					</div>
					<div class="mb-3">
						<label for="regDate" class="form-label">날짜</label> <input
							type="text" class="form-control" id="regDate" name="auregDate"
							value="${board.auregDate}" disabled>
					</div>

<a href="getBoardList.do" class="btn btn-outline-primary" style="text-align:center; width:200px; font:50px;">목록</a>
			</div>
		</div>
	</div>
	</main>
