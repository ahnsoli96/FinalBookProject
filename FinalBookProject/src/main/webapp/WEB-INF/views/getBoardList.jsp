...
<main>
  ...
  <div class="b-example-divider"></div>
	 <nav>
		<div style="float:left;"class="vertical-menu">
	 	 <a href="./getBoardList.do" class="active" >공지사항</a>
	  	 <a href="./getFreeBoardList.do">자유게시판</a>
	  	 <a href="./getcumuBoardList.do" >커뮤니티게시판</a> 	
		</div>
	</nav>
	...
	<div align="center">
		...
		<div>&nbsp;</div>
		<div>&nbsp;</div>
		<div style="margin-right:320px;"><h4>Announcement</h4></div>
		<div>&nbsp;</div>	
		<!-- 검색 시작 -->
			<form action="./getBoardsearchList.do" method="get">
			<table border="0" cellpadding="0" cellspacing="0" width="900" style="margin-right:320px;">
				<tr>
					<td align="right">
						<select name="searchCondition" style="height:35px; width:60px;" id="searchkeyword" onchange="shChangeValue()" >
 ...
 <script>
    $(document).ready(function() {
    	...
    	var inputSource = ${contentsearchlist}
   ...
   function shChangeValue() {
    	...
    	if(value_str.value =='AUTITLE'){ //자바는 참조주소 비교되니깐 equals를쓰지만 다른대는 문자열비교도 ==씁니다
    		var inputSource = ${titlesearchlist}
            $('#inputBox').autocomplete({
                source : inputSource,
                minLength : 0
            }).focus(function() {
		...
		<table class="table-striped table-hover" width="900">
			<tr align="center">
				<th bgcolor="#32A4FF" width="100">번호</th>
				<th bgcolor="#32A4FF" width="200">제목</th>
				<th bgcolor="#32A4FF" width="150">작성자</th>
				<th bgcolor="#32A4FF" width="150">등록일</th>
				<th bgcolor="#32A4FF" width="100">조회수</th>
			</tr>
			<c:forEach items="${boardList}" var="board">
				<tr align="center" height="50">
					<td>${ board.auseq }</td>
					<td align="center">
						<a href="getBoard.do?auseq=${board.auseq}">${board.autitle}</a>
					</td>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="getBoardList.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="getBoardList.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="getBoardList.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}">Next</a></li>
