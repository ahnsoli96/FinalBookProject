		...
		<div class="card mb-4" style="width:1000px; margin:auto;">
			<div class="card-body" style="width:1000px;">
				<form action="/deletehope.do">
					...
					<div class="mb-3">
						<label for="title" class="form-label">희망 도서 제목</label> <input
							type="text" class="form-control" id="title" name="title" value="${board.title}" disabled>
					</div>
					<div class="mb-3">
						<label for="author" class="form-label">지은이</label> <input
							type="text" class="form-control" id="author" name="author" value="${board.author}" disabled>
					</div>
					<div class="mb-3">
					...
					<a href="updatehopepage.do?seq=${board.seq}" class="btn btn-outline-success"
						>수정</a>
					<a href="hopelist.do" class="btn btn-outline-warning">목록</a>
					<input class="btn btn-outline-danger" type="submit" value="삭제" onclick="return confirm('삭제하시겠습니까?')">
				</form>
			</div>
		</div>
	</div>
