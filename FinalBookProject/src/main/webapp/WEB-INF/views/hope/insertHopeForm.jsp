 ...
 <div class="container" >
  ...
  <path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811V2.828zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492V2.687zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z"/>
     ...
     <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      ...
      <div class="dropdown-content">
   	 ...
   	 <li>&nbsp;</li>
   	 <div class="dropdown">
      <button class="dropbtn">hope book</button>
      <div class="dropdown-content">
        <a href="/hopelist.do">희망도서신청</a>
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
	...
	<div class="container-fluid px-4">
		<h1 class="mt-4" align="center">희망 도서 신청</h1>
			&nbsp;
		<div class="card mb-4" style="width:1000px; margin:auto;">
			<div class="card-body" style="width:1000px;">
				<form action="./inserthope.do" method="post" id="bookForm">
					<input type="hidden" name="writer" value="${id}">
					<div class="mb-3">
						<label for="title" class="form-label">신청 도서 제목</label> 
						<input type="text" class="form-control" id="title" name="title">
					</div>
					<div class="mb-3">
						<label for="title" class="form-label">신청자</label> 
						<input type="text" class="form-control" id="writer" name="writer" value="${id}" disabled>
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<textarea class="form-control" id="content" name="content" cols="40" rows="9"></textarea>
					</div>
					<div class="mb-3">
				    ...
				    var inputField = document.getElementById("regDate");
