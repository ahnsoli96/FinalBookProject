...
<main>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="900">
				<tr>
					<td align="right">
						...
						<button type="submit" class="btn btn-outline-primary me-2" style="height:35px; width:50px; margin-bottom:5px;" /><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		...
		<table class="table-striped table-hover" width="900">
			...
			<c:forEach items="${boardList}" var="boardList">
				<tr align="center" height="50">
					<td>${ boardList.seq }</td>
					<td align="center">
						<a href="gethope.do?seq=${boardList.seq}">${boardList.title}</a>
					</td>
		...
		<td align="right">
		<br>
		<button class="btn btn-outline-primary me-2" style="float-right;" onclick="location.href ='inserthope.do'"; >새글 등록</button>
		</td>
		</tr>
		</table>
		</form>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="hopelist.do${pageMaker.makeQuery(pageMaker.cri.page - 1)}">Previous</a></li>
    
     <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    <li class="page-item"><a class="page-link" href="hopelist.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
    </c:forEach>
    
    <li class="page-item"><a class="page-link" href="hopelist.do${pageMaker.makeQuery(pageMaker.cri.page + 1)}">Next</a></li>
