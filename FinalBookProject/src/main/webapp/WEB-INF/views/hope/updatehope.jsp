				...
				<form action="/updatehope.do">
					...
					<div class="mb-3">
						<label for="author" class="form-label">지은이</label> <input
							type="text" class="form-control" id="author" name="author" value="${board.author}" >
					</div>
					<div class="mb-3">
					...
					<button onclick="history.go(-1)" class="btn btn-outline-danger">취소</button>
				</form>
				<script>
