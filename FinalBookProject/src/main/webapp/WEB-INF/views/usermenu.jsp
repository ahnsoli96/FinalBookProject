...
<img src="image/person.jpg" class="rounded mx-auto d-block" alt="..."  style="width:1200px;"> 
<div>&nbsp;</div>
<img src="image/new.jpg" class="rounded mx-auto d-block" alt="..." style="width:1200px;" > 
<img src="image/step.png" class="rounded mx-auto d-block" alt="..."  style="width:1200px;"> 
<img src="image/lbr.jpg" class="rounded mx-auto d-block" alt="..."  style="width:1200px;">

	<div id="punny">
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-center" >
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">Start Reading</h1>
      <p class="lead fw-normal">Reading enriches life and brings leisure to life</p>
      <a class="btn btn-light" href="/joinmembership.me">Join Us!</a>
    </div>
